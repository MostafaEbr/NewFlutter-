...
class BusinessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      ...
      {
        case 'business' :
          BusinessCubit().get(context).getBusinessApi();
          break;
        case 'sports' :
          BusinessCubit().get(context).getSportsApi();
          break;
      }


      return BlocConsumer<BusinessCubit, Business_Status>(
        listener: (context, state) {
          if (state is BusinessErrorStatus) {
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            body: ConditionalBuilder(
              condition: state is! BusinessLoadingStatus,
